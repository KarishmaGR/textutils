...
export default function About() {
  ...
  const [mystyle, setmystyle] = useState({
    ...
    const [setbtn, setsetbtn] = useState('Enable Dark Mode')
  const toggelStyle = ()=>{
    ...
    return (
        <div className='container my-4' style={mystyle}>
            ...
            <button  type="button" className="btn btn-primary my-3" onClick={toggelStyle}>{setbtn}</button>
